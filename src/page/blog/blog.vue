      ...
      >
        ...
        >
            ...
            <div class="comment-info">
              <div class="comment-user-nickname">
                <span
                  ...
                  >博主</span
                >
                <span class="text-orange text-bold user-nickname">{{
                  data.nickname
                }}</span>
          ...
          <div
            class="comment-huifu"
            v-if="data.commentp"
            style="background: rgba(197,233,155,.4);padding: 0px;border-radius: 10px;margin-top: 10px"
          >
            <div
              style="position: relative;left: 20px;top: 20px;font-size: 14px;font-weight: bold;color: #ef5285;"
            >
              回复
            </div>
            <div
              class="comment-bar"
              style="transform: translateZ(0) scale(.8);margin-top: unset !important"
            >
              <div class="comment-user-info">
                <div class="comment-user-avatar">
                  <img :src="data.commentp.avatar" />
                </div>
                <div class="comment-info">
                  <div class="comment-user-nickname">
                    <span
                  ...
                  <div class="comment-text text-gray">
                    <span
                      ...
                      天前 来自:
                      {{
                        data.commentp.province != '' &&
                        data.commentp.province != '[]' &&
                        data.commentp.province != null
                          ? data.commentp.province
                          : ''
                      }}{{
                        data.commentp.city != '' &&
                        data.commentp.city != '[]' &&
                        data.commentp.city != null
                          ? data.commentp.city
                          : ''
                      }}{{
                        (data.commentp.city == '' ||
              ...
              <div class="comment-content">
                <div class="comment-imgs">
                  <div
                    class="c-img-item"
                    v-for="url in data.commentp.contentimg"
                  >
...
export default {
  ...
  data() {
    return {
      ...
      showMask: false,
      qqAvatar:
        'https://xiamo.oss-accelerate.aliyuncs.com/xiamo_avatar/2021041004472500896694.jpg',
      qqnickname: '',
      qq: '',
      qqEmail: '',
      showhuifu: false,
          ...
          response.forEach(function(res) {
            ...
            if (res.commentp) {
              ...
              if (comment2.indexOf('[img]') > -1) {
                res.commentp.contentimg = comment2
                  .match(img)[1]
                  .split('[/img][img]');
