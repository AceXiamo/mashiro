<template>
  <div class="tools">
    ...
    <div
      ...
      :style="{
        left:
          (proportionL < 1 && proportionL != ''
            ? -10 * proportionL
            : proportionR < 1 && proportionR != ''
            ? -10 + -10 * (1 - proportionR)
            : '-10') + 'vw',
        transition:
          proportionL < 1 && proportionL != ''
    ...
    >
      <div class="ani">
        ...
        <div class="img2" :style="{ opacity: 1 - proportionL }">
          <img src="static/bilibili/bg2.jpg" />
        </div>
        <div class="img3" :style="{ opacity: 1 - proportionR }">
          <img src="static/bilibili/bg3.png" />
        </div>
        <!--      -->
        <div class="img3 tree" :style="{ opacity: 1 - proportionR }">
          <img src="static/bilibili/bg4.png" />
        </div>
        <!--      -->
        <div class="img2" :style="{ opacity: 1 - proportionL }">
          <img src="static/bilibili/bg5.png" />
        </div>
        <!--      -->
        <div
          class="img4 tree"
        ...
        >
          <img src="static/bilibili/bg6.png" />
        </div>

        <!--      -->
        <div class="img2 tree" :style="{ opacity: 1 - proportionL }">
          <img src="static/bilibili/bg7.png" />
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      content:
        '' +
        '<pre class="ql-syntax" spellcheck="false">css:  transition: left 0.5s cubic-bezier(0.32, -0.02, 0.58, 1.49),top 0.5s cubic-bezier(0.32, -0.02, 0.58, 1.49);\n' +
        '' +
  ...
  methods: {
    ...
    mousemove(e) {
      ...
      this.proportionR =
        (this.fullWidth - e.clientX) / (this.fullWidth - this.firstClientX);
    },
    mouseenter(e) {
      var this_ = this;
      var timeOutId = null;
      ...
      var move = function(ev) {
        ...
        this_.proportionR =
          (this_.fullWidth - ev.clientX) /
          (this_.fullWidth - this_.firstClientX);
...
.emm-content {
  ...
  .shadow {
    ...
    align-items: center;
    filter: drop-shadow(0px 0px 12px rgba(165, 147, 224, 0.8));
    .text {
      width: 80px;
      padding: 3px 15px;
      background: #a593e0;
